	...
	<body>
		<div style="font-size: 12.5px !important;">
			<table class="left" width="50%" cellspacing="0" cellpadding="0" >
				...
				<tr>
					<td class="text-uppercase">Vencim: {{ $data->date_advance_I->addDays(60)->format('d-m-Y') }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; F.Pago: {{ $data->date_advance_I->format('d-m-Y') }}</td>
					<td class="text-center">*</td>
				</tr>
				<tr>
					<td><hr></td>
				...
				<tr>
					<td class="text-uppercase text-center">Cuota:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{ $data->advance_I }}</td>
					<td class="text-center">*</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="text-uppercase text-center">Resta: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{ $data->sale->total - $total }}</td>
					<td class="text-center">*</td>
				</tr>
				<tr>
					<td><hr></td>
